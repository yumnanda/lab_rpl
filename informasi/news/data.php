            ...
            <div class="container">
                <div class="row mx-1 mb-2">
                    ...
                    <div class="col-md-6 text-right text-primary a">
                        ...
                        <a href="#" class="mx-2">Informasi</a>
                        <p class="d-inline-block"><i class="fas fa-angle-right"></i></p>
                        <p class="d-inline-block text-secondary ml-2">News</p>
                    </div>    
                </div>
            </div>
        </div>
    ...
    <div class="wrap-content">
        <div class="container">
            ...
            while($data = mysqli_fetch_array($query)){
                ...
                echo "<img class='mb-5' src='../../asset/img/uploads/news/".$data['file']."'>";
                echo $data['content'];
            }
            ?>
        </div>
