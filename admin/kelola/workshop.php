...
<body>
                            ...
                            <div class="garis-bawah">
                                <div class="row mx-0.5">
                                    ...
                                    <div class="col-md-6 text-right text-primary a">
                                        ...
                                        <p class="d-inline-block"><i class="fas fa-angle-right"></i></p>
                                        <p class="d-inline-block text-secondary ml-2">Workshop</p>
                                    </div>    
                                </div>
                            </div>
                            <form id="form" action="../proses/create.php" method="POST" enctype="multipart/form-data" >
                                <input type="hidden" name="data" value="workshop">
    ...
    <script>
        $(document).ready(function () {
            $(".view").load("../view/view-workshop.php");
            $(document).on('click','.hapus', function () {
                var id = $(this).attr('id');
                $.ajax({
                    type: "post",
                    url: "../proses/delete.php",
                    data: {data:'workshop',id:id},
                    success: function () {
                        $(".view").load("../view/view-workshop.php");
                    }
                });
