...
<body>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click','.edit', function () {
            ...
            $('#nama').val(nama);
            var nidn = row.closest("tr").find("td:eq(2)").text();
            $('#nidn').val(nidn);
            var jabatan = row.closest("tr").find("td:eq(3)").text();
            $('#jabatan').val(jabatan);
            var minat = row.closest("tr").find("td:eq(4)").text();
            $('#minat').val(minat);
            var email = row.closest("tr").find("td:eq(5)").text();
            $('#email').val(email);
        });
    });
</script>
