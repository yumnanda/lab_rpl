...
<table class="table table-responsive-sm table-bordered table-light text-center">
    ...
    <tbody>
        ...
        while($data = mysqli_fetch_array($query)){
            ...
            echo '<td>
                    <img src="../../asset/img/uploads/materi/'.$data['file'].'" height="60" width="75" class="img-thumbnail"/>
                </td>';
            echo "<td class='text-left'>".$data["content"]."</td>";
            $update = "<a href='../proses/update-artikel.php?id=".$data['id']."&data=materi&page=Materi' class='btn btn-info'>Edit</a>";
