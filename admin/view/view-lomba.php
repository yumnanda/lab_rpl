...
<table class="table table-responsive-sm table-bordered table-light text-center">
    ...
    <tbody>
        ...
        while($data = mysqli_fetch_array($query)){
            ...
            echo '<td>
                    <img src="../../asset/img/uploads/lomba/'.$data['file'].'" height="60" width="75" class="img-thumbnail"/>
                </td>';
            echo "<td class='text-left'>".$data["content"]."</td>";
            $update = "<a href='../proses/update-artikel.php?id=".$data['id']."&data=lomba&page=lomba' class='btn btn-info'>Edit</a>";
