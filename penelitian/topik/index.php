...
<head>
    ...
    <title>Topik Research | RPL Udinus</title>
        ...
        <div class="garis-bawah">
            <div class="container">
                <div class="row mx-1 mb-2">
                    ...
                    <div class="col-sm-8 text-right text-primary a">
        ...
        <div class="container">
            <table class="table table-responsive-sm table-hover table-light">
                    ...
                    while($data = mysqli_fetch_array($query)){
                        ...
                        echo "<td class='text-center'><a href='data.php?id=".$data['id']."' class='btn btn-success'><i class='fas fa-link'></i></a></td>";
                        echo "</tr>";
                    }
                    ?>
            </table>
